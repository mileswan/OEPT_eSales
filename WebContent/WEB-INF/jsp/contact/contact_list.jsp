		...
		<div class="page-content">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" id="delContact" class="btn blue" data-dismiss="modal">删除</button>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/contact/list.do"">联系人管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path %>/contact/list.do"">联系人列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
											<div class="actions">
												<a href="<%=path %>/contact/contact_add.do" data-toggle="modal" class="btn green">
	                		...
	                		<tr class="odd gradeX">
	                    		...
	                    		<td id="${contact.contact_id}"><a href="<%=path%>/contact/contact_details.do?id=${contact.contact_id}">${contact.contact_name}</a></td>
	                    		<td>
	                    			性别：
	                    			<c:choose>
										...
										<c:otherwise>
											<span class="label label-sm label-danger">女</span>
										</c:otherwise>
									</c:choose>   
									<br/>
									年龄:   ${contact.age}      		
