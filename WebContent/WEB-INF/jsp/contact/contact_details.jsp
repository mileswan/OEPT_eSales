...
<!--      					</div> -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/inventory/warehouse_details.do?id=${warehouseDetails.id}">联系人详细信息</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
												...
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" name="updateId" id="updateId" value="${contactDetails.contact_id }" style="display: none;">
															<input type="text" class="form-control" placeholder="请输入联系人姓氏…" name="updateFirstname" id="updateFirstname" value="${contactDetails.first_name }">													
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label">名字：<span class="required">* </span></label>
															<input type="text" class="form-control" placeholder="请输入联系人名字…" name="updateLastname" id="updateLastname" value="${contactDetails.last_name }">													
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															...
															<input class="form-control date-picker" size="16" type="text" value="${contactDetails.birthday }" data-date="1990-01-01" data-date-format="yyyy-mm-dd" data-date-viewmode="years" id="updateBirthday" name="updateBirthday"/>
															</div>
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入联系人年龄…" name="updateAge" id="updateAge" value="${contactDetails.age }" readonly="readonly">	
														</div>
													</div>
												</div>
												<!--/row-->
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入联系人传真…" name="updateFax" id="updateFax" value="${contactDetails.fax }"
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入联系人E-mail…" name="updateEmail" id="updateEmail" value="${contactDetails.email }">													
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
																<label class="control-label">个人电话：</label>
															<input type="text" class="form-control" placeholder="请输入联系人个人电话…" name="updateCellphone" id="updateCellphone" value="${contactDetails.cellphone }"
															onKeyPress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false" onkeyup="numTesting()" maxlength="11">	
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入联系人办公电话…" name="updateWorkphone" id="updateWorkphone" value="${contactDetails.workphone }"
															onKeyPress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false" onkeyup="numTesting()" maxlength="11">	
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入联系人职称…" name="updateTitle" id="updateTitle" value="${contactDetails.title }">	
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label">部门：</label>
															<input type="text" class="form-control" placeholder="请输入联系人部门…" name="updateDepartment" id="updateDepartment" value="${contactDetails.department }">	
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="radio-list">
																<c:choose>
																	<c:when test="${contactDetails.gender == '1'}">
																		<label class="radio-inline">
																		<input type="radio" name="updateGender" id="updateGender" value="true" checked="checked">男</label>
																		<label class="radio-inline">
																		<input type="radio" name="updateGender" id="updateGender" value="false">女 </label>
																	</c:when>
																	<c:otherwise>
																		<label class="radio-inline">
																		<input type="radio" name="updateGender" id="updateGender" value="true">男</label>
																		<label class="radio-inline">
																		<input type="radio" name="updateGender" id="updateGender" value="false" checked="checked">女 </label>
																	</c:otherwise>
																</c:choose>   
															</div>
														</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name="addAddressId" id="updateAddressId" value="${contactDetails.primary_addr_id }" style="display: none;">
															<div class="input-group">
																<input type="text" class="form-control" placeholder="请选择地址…" id="updateAddressName" name="addAddressName" value="${contactDetails.address.allAddress }" readonly>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name="addAccountId" id="updateAccountId" value="${contactDetails.account_id }" style="display: none;">
															<div class="input-group">
																<input type="text" class="form-control" placeholder="请选择单位…" id="updateAccountName" name="addAccountName" value="${contactDetails.account.accountName }" readonly>
																<span class="input-group-addon">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<textarea class="form-control" rows="3"
																placeholder="输入描述…" name="updateComment" id="updateComment">${contactDetails.comment }</textarea>
														</div>
													</div>
												</div>
												<!--/row-->
													...
													<div class="col-md-6">
														<div class="form-group">
															<p class="form-control-static">
																此记录是由${contactDetails.created_name}在 ${contactDetails.created}创建</p>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<p class="form-control-static">
																此记录最近一次修改是由${contactDetails.update_name}在 ${contactDetails.updated}更新</p>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="a-div-b">
											<button type="button" class="btn blue" id="updateContactButton">
