				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							 确认要删除该职位？（删除该职位会删除所有该职位的引用）
						</div>
						<div class="modal-footer">
							<button type="button" id="delContact" class="btn blue" data-dismiss="modal" onclick="alert(543)">确认删除</button>
											...
											<c:forEach var="pList" items="${positionList }">
												...
												<tr class="odd gradeX">
													...
													<td>
														...
														<a href="#delete-confirm" data-toggle="modal" onclick="deleteId(${pList.positionId})">删除</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
