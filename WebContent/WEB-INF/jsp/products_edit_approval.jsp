 ...
 * Version: 1.0
 * Date: 2016/2/22
 * Description:  product details approval page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
<head>
<meta charset="utf-8"/>
<title>OEPT eSales - 产品/服务信息审核</title>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/prodadmin/approval_list.do">待审核产品/服务列表</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="#">审核产品/服务</a>
