...
<%-- 										</c:if> --%>
<!-- 										<li> -->
<%-- 											<a href="exportSO.do?orderId=${order.order_id}&orderNumber=${order.order_number}"> --%>
<!-- 											导出到Excel </a> -->
<!-- 										</li> -->
												...
												<div class="portlet yellow-crusta box">
													...
													<div class="portlet-body">
														...
														<div class="row static-info">
																...
																<div class="col-md-7 value">
																	<select class="form-control" name="order[receipt_status]" <c:if test="${readOnlyFlag == true}">readonly</c:if>>
																		<c:forEach var="receipt_status" items="${receipt_status_list}">
																			<option value="${receipt_status.list_name}" <c:if test="${order.receipt_status_code == receipt_status.list_name}">selected</c:if> >${receipt_status.list_value}</option>
																		</c:forEach>
																	</select>
																</div>
														</div>
														<div class="row static-info">
																<div class="col-md-5 name">收款款百分比：</div>
																<div class="col-md-7 value">
																	<div class="input-inline input-medium">
																		<input type="text" value="${order.receipt_ratio}" name="order[receipt_ratio]" class="form-control touchspin_percent" <c:if test="${readOnlyFlag == true}">readonly</c:if>>
																	</div>
																</div>
														</div>
														<div class="row static-info receipt-due-date" <c:if test="${order.receipt_status_code != 'Overdue'}">style="display:none;"</c:if>>
															<div class="col-md-5 name">
																 逾期日期:
															</div>
															<div class="col-md-7 value">
																<div class="input-group input-medium date date-picker"
																	...
																	<input type="text" class="form-control" readonly
																		name="order[receipt_due_date]" value="${order.receipt_due_date}">
																	<c:if test="${readOnlyFlag == false}">
											...
											<div class="col-md-6 col-sm-12">
												<div class="portlet red-sunglo box">
													<div class="portlet-title">
														...
														<c:if test="${readOnlyFlag == false}">
														<div class="actions">
															<a href="javascript:;" class="btn btn-default btn-sm so-comment-update">
															<i class="fa fa-pencil"></i> 保存更改 </a>
														</div>
														</c:if>
													</div>
...
<!-- 														</div> -->
<!-- 														<div class="actions"> -->
<!-- 															<a href="#delivery-wh-pick" class="btn btn-default btn-sm delivery-wh-pick" data-toggle="modal"> -->
<!-- 															<i class="fa fa-pencil"></i> 选取发货仓库 </a> -->
<!-- 														</div> -->
<!-- 													</div> -->
<!-- 													<div class="portlet-body delivery-wh-info"> -->
<!-- 														<div class="row static-info"> -->
<!-- 															<div class="col-md-5 name"> -->
<!-- 																 仓库编号: -->
<!-- 															</div> -->
...
<!-- 											</div> -->
										<div class="col-md-6 col-sm-12">
											<div class="portlet blue-hoki box">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-cogs"></i>直接客户信息
														</div>
														<c:if test="${readOnlyFlag == false}">
														<div class="actions">
															<a href="#customer-pick" class="btn btn-default btn-sm customer-pick" data-toggle="modal">
															<i class="fa fa-pencil"></i> 选取直接客户 </a>
														</div>
														</c:if>
													</div>
													<div class="portlet-body customer-info">
														<div class="row static-info">
															<div class="col-md-5 name">
																 客户编号:
															</div>
											...
											<div class="col-md-6 col-sm-12">
												<div class="portlet blue-hoki box">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-cogs"></i>间接客户信息
														</div>
														<c:if test="${readOnlyFlag == false}">
														<div class="actions">
															<a href="#customer-lv2-pick" class="btn btn-default btn-sm customer-lv2-pick" data-toggle="modal">
															<i class="fa fa-pencil"></i> 选取间接客户 </a>
														</div>
														</c:if>
													</div>
													<div class="portlet-body customer-lv2-info">
														<div class="row static-info">
															<div class="col-md-5 name">
																 客户编号:
															</div>
															<div class="col-md-7 value">
																 ${customer_lv2.accountNumber}
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
														...
														<div class="row static-info">
															...
															<div class="col-md-7 value">
																 ${customer_lv2.address.allAddress}
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
										...
										<div class="row">
											<div class="col-md-6 col-sm-12">
												<div class="portlet green-meadow box">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-cogs"></i>区域详情
														</div>
														<c:if test="${readOnlyFlag == false}">
														<div class="actions">
															<a href="#area-pick" class="btn btn-default btn-sm area-pick" data-toggle="modal">
															<i class="fa fa-pencil"></i> 选取区域 </a>
														</div>
														</c:if>
													</div>
													<div class="portlet-body area-info">
														<div class="row static-info">
															<div class="col-md-5 name">
																  省/直辖市:
															</div>
											...
											<div class="portlet green-meadow box">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-cogs"></i>地址详情
														</div>
														<c:if test="${readOnlyFlag == false}">
														<div class="actions">
															<a href="#" class="btn btn-default btn-sm address-names-update" data-toggle="modal">
															<i class="fa fa-pencil"></i> 保存地址 </a>
														</div>
														</c:if>
													</div>
													<div class="portlet-body address-info">
														<div class="row static-info">
															<div class="col-md-5 name">
																 收货地址:
															</div>
															<div class="col-md-7 value">
																 <input type="text" class="form-control" placeholder="请输入收货地址…" name="order[ship_address]" value="${order.ship_addr_name}" <c:if test="${readOnlyFlag == true}">readonly</c:if>>
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
															...
															<div class="col-md-7 value">
																 <input type="text" class="form-control" placeholder="请输入账单地址…" name="order[bill_address]" value="${order.bill_addr_name}" <c:if test="${readOnlyFlag == true}">readonly</c:if>>
															</div>
														</div>
													</div>
												</div>
...
<!-- 																<th> -->
<%-- 																	 基础单价（${order.currency_val}） --%>
<!-- 																</th> -->
																<th>
																	 销售单价（${order.currency_val}）
																</th>
																<th>
																	 销售数量
																</th>
...
<!-- 																</th> -->
															...
															<tbody>
															<!-- Generated by so-view-events.js -->
															</tbody>
															</table>
														</div>
													</div>
...
<!-- 													</div> -->
	                		...
	                		<tr class="odd gradeX" id="${related_req.requisition_id}">
	                    		<td><a href="<%=path%>/inventory/stock_out_details.do?id=${related_req.requisition_id}">
	                    		...
	                    		<td>
									...
									<div class="portlet">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-shopping-cart"></i>订单更新历史记录
											</div>
											<div class="actions">
