...
<!-- 								</div> -->
						...
						<div class="modal-footer">
							...
							<button type="button" id="new-so-cancel" class="btn default" data-dismiss="modal">取消</button>
						</div>
					</div>
					<!-- /.modal-content -->
				</div>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/order/so_all_list.do">销售管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path%>/order/so_all_list.do">所有销售单列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>所有销售订单列表
							</div>
							<div class="tools">
...
<!-- 									</div> -->
	                		...
	                		<tr class="odd gradeX" id="${sales_order.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/order/so_all_details.do?id=${sales_order.order_id}">
