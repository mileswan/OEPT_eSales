 ...
 * Version: 1.0
 * Date: 2016/1/6
 * Description:  Sales Order all details management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
<head>
<meta charset="utf-8"/>
<title>OEPT eSales - 销售订单详情</title>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/order/so_all_list.do">所有销售订单列表</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path %>/order/so_all_details.do?id=${order.order_id}">销售订单详情</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
