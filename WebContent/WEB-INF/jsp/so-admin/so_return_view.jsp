 ...
 * Version: 1.0
 * Date: 2016/1/6
 * Description:  Sales Return Order details management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
<head>
<meta charset="utf-8"/>
<title>OEPT eSales - 销售退货订单详情</title>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">删除销售退货项</h4>
						</div>
			...
			<div class="modal fade" id="add-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">新建销售退货项目</h4>
						</div>
						<div class="modal-body">
						<form class="form-horizontal form-bordered" id="add-item-form">
							<div class="form-body">
								...
								<div class="form-group">
													<label class="col-md-3 control-label">销售退货单价（元）：
													</label>
													<div class="col-md-8">
			...
			<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">编辑销售退货项目</h4>
						</div>
						<div class="modal-body">
...
<!-- 														<br><a href="#product-pick" class="col-md-8 product-pick" data-toggle="modal">点击此处选择产品</a> -->
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			销售退货订单详情 <small>查看销售退货订单详情</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/order/sor_list.do">销售退货订单列表</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path %>/order/sor_details.do?id=${order.order_id}">销售退货订单详情</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-shopping-cart"></i>销售退货单号${order.order_number} <span class="hidden-480">
								| ${order.order_type} </span>
							</div>
							<div class="actions">
								<a href="so_return_list.do" class="btn default yellow-stripe">
										...
										<div class="row">
											<div class="col-md-6 col-sm-12">
												<div class="portlet yellow-crusta box">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-cogs"></i>销售退货订单基本信息
														</div>
													</div>
													<div class="portlet-body">
											...
											<div class="col-md-6 col-sm-12">
												<div class="portlet red-sunglo box">
													<div class="portlet-title">
														...
														<div class="actions">
															<a href="javascript:;" class="btn btn-default btn-sm sor-comment-update">
...
<script src="../scripts/order/sor-view-events.js" type="text/javascript"></script>
<script>
