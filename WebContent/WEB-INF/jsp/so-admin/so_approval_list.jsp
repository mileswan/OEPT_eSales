...
<!-- 								</div> -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/order/so_approval_list.do">销售管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path%>/order/so_approval_list.do">待审核销售单列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>待审核销售订单列表
							</div>
							<div class="tools">
...
<!-- 							</div> -->
	                		...
	                		<tr class="odd gradeX" id="${sales_order.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/order/so_approval_details.do?id=${sales_order.order_id}">
