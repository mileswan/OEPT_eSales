		...
		<div class="modal-dialog" >
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" onclick="newAddressSubmit()" class="btn blue">保存地址</button>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/user/address.do">地址管理</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
	                		...
	                		<tr class="odd gradeX">
	                    		...
	                    		<td ><a href="<%=path%>/user/selectAddressId.do?addressId=${aList.addressId }&readonly=0">${aList.allAddress }</a></td>
	                    		<td>${aList.contactCell }</td>
								<td>${aList.contactName }</td>
								<td>
								<c:forEach var="user" items="${aList.user}" begin="0" end="1" step="1" varStatus="status">
								${user.userName }
								<br/>
								<c:if test="${status.last }">...</c:if>
								</c:forEach>
								</td>
	                    		<td><a href="<%=path%>/user/selectAddressId.do?addressId=${aList.addressId }&readonly=1">分配地址</a></td>
	                  		</tr>	
							</c:forEach>		
							</tbody>
							</table>
