												...
												<div class="form-body">
													<div class="div_up" id="div_up">
														<table
															...
															<tbody>
															<c:forEach var="list" items="${oraList }">
											...
											<div class="tab-pane active" id="tab_return">
												...
												<div class="div_down">
													<table class="table table-striped table-bordered table-hover"
														...
														<tbody>
															<c:forEach var="list" items="${rtList }">
																<%--用EL表达式调用list对象的属性循环输出对象的各个属性值--%>
																<tr class="odd gradeX">
																	<td>${list.serviceId }</td>
																	<td><a href="<%=path %>/order/details.do?id=${list.orderId }">${list.order.order_number }</a></td>
																	...
																	<td>${list.serviceCreated }</td>
																	<td>
																		<a onclick="disposeReturn4(${list.serviceId },7)">取消</a>
																	</td>
																</tr>
															</c:forEach>
														</tbody>
														...
														<table
															...
															<tbody>
																...
																<tr class="odd gradeX">
																	...
																	<td>
																	<a onclick="disposeReturn4(${list.serviceId },7)">取消</a>
																	<c:if test="${list.serviceStatus ==5 }">
																	/<a onclick="disposeReturn4(${list.serviceId },3)">已收货</a>
																	</c:if>
																	</td>
																</tr>
																</c:forEach>
