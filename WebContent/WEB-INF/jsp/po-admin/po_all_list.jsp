 ...
 * Version: 1.0
 * Date: 2015/12/18
 * Description:  Purchase orders all list management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
...
<!-- 								</div> -->
						...
						<div class="modal-footer">
							...
							<button type="button" id="new-po-cancel" class="btn default" data-dismiss="modal">取消</button>
						</div>
					</div>
					<!-- /.modal-content -->
				</div>
...
<!-- 												<a href="po_all_import_view.do" class="btn blue"> -->
...
<!-- 									</div> -->
	                		...
	                		<tr class="odd gradeX" id="${purchase_order.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/order/po_all_details.do?id=${purchase_order.order_id}">
