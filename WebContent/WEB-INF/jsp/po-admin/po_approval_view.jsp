 ...
 * Version: 1.0
 * Date: 2016/1/14
 * Description:  Purchase Order approval details management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
<head>
<meta charset="utf-8"/>
<title>OEPT EIMS -待审核采购单详情</title>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/order/po_approval_details.do?id=${order.order_id}">待审核采购订单详情</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
...
<script src="../scripts/order/po-approval-events.js" type="text/javascript"></script>
