				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-shopping-cart"></i>项目编号：2-132461782
							</div>
							<div class="actions">
...
<!-- 									</li> -->
									...
									<li>
										<a href="#tab_tasks" data-toggle="tab">
										项目任务进度 </a>
									</li>
									<li>
													...
													<div class="portlet-body">
														<div class="row static-info">
															...
															<div class="col-md-7 value">
																 <input type="text" class="form-control" placeholder="请输入项目名称…" name="order[man_number]" value="四季度园区网络改造项目">
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
													...
													<div class="portlet-body">
														<div class="form-group">
															<textarea class="form-control" rows="6"
																placeholder="输入项目描述…" name="order[description]" <c:if test="${readOnlyFlag == true}">readonly</c:if>>${order.order_comment}</textarea>
														</div>
													</div>
												</div>
											</div>
...
<!-- 																	</a> -->
															...
															<a href="#"
																		class="btn btn-lg green m-icon-big submit-order">
																		下一阶段 <i class="m-icon-big-swapup m-icon-white"></i>
																	</a>
