 ...
 * Version: 1.0
 * Date: 2016/5/28
 * Description:  Projects details management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE MODALS-->
			<jsp:include page="project_modals.jsp" />
			<!-- BEGIN PAGE MODALS-->
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			项目详情 <small>查看项目详情</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/order/po_list.do">我的项目列表</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path %>/order/po_details.do?id=${order.order_id}">项目详情</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			...
			<!-- BEGIN PAGE CONTENT-->
			<jsp:include page="project_contents.jsp" />
			<!-- END PAGE CONTENT-->
		</div>
	</div>
	<!-- END CONTENT -->
