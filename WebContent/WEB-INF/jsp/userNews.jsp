		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/user/newUserSkip.do">新建用户</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
									...
									<div class="portlet-body form">
										...
										<form action="" id="update_form"  method="post">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入用户名…" name="username" id="username" value="" onblur="testingUser(this)" >	
														...
														<div class="form-group">
															<label>电子邮箱：</label>
																<div class="input-group">
																	...
																	</span> <input type="text" class="form-control" name="emailaddress" id="emailaddress" value=""
																		placeholder="电子邮箱…" onblur="checkEmail()">
																		<input type="text" name="userId" value="" style="display: none;">
																</div>
																<span id="testingemail"></span>		
															</div>
													</div>	
												</div>
												<!--/row-->
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入姓氏…" name="lastname" id="lastname" value="">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label">名字：</label>
															<input type="text" class="form-control" placeholder="请输入名字…" name="firstname" id="firstname" value="">
														</div>
													</div>
												</div>
												<!--/row-->
														...
														<div class="form-group">
															...
															<div class="input-group">
																<input type="password" class="form-control" name="password"
																	id="newPassword" placeholder="请输入新密码…"  onblur="passwordSpan()">
																<span class="input-group-addon"> <i
																	class="fa fa-user"></i>
																</span>
															</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="theme-option">
																...
																<input type="text" class="form-control" placeholder="请输入地址…" name="address" id="address" value="">
															</div>				
														</div>
													</div>
												</div>
											...
											<div class="form-actions right">
												<button type="button" onclick="ajaxPostSubmit()" class="btn blue" id="updateUser-confirm">
...
<script src="../scripts/users/userNews.js" type="text/javascript"></script>
