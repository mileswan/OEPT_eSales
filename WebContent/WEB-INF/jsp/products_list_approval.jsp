...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="modal fade" id="new-product" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="row">
							<div class="col-md-6">
								<label class="control-label">产品/服务编号：</label><span class="required">* </span>
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			产品/服务审核管理 <small>待审核产品/服务列表</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/prodadmin/approval_list.do">产品/服务审核管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="#">待审核产品/服务列表</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>待审核产品/服务列表
							</div>
							<div class="actions">
...
<!-- 								</div> -->
								<table class="table table-striped table-bordered table-hover" id="approval_datatable_products">
									<thead>
