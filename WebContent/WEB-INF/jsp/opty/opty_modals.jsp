			...
			<div class="modal fade" id="add-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">编辑销售团队成员</h4>
						</div>
						<div class="modal-body">
			...
			<div class="modal fade" id="add-product-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">添加产品/服务</h4>
						</div>
						<div class="modal-body">
...
<!-- 														<br><a href="#product-pick" class="col-md-8 product-pick" data-toggle="modal">点击此处选择产品</a> -->
								...
								<div class="form-group">
							 	...
							 	<div class="form-group">
										<label class="control-label col-md-3">预期销售数量：</label>
										<div class="col-md-9">
			...
			<div class="modal fade" id="add-visit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">编辑销售拜访</h4>
						</div>
						<div class="modal-body">
						<form class="form-horizontal form-bordered" id="add-item-form">
							<div class="form-body">
								<div class="form-group">
									<input type="text" name="order[id]" style="display :none;" value="${order.order_id}">
									<input type="text" name="product[id]" style="display :none;" value="">
													<label class="col-md-3 control-label">拜访对象： <span class="required">
													* </span>
													</label>
													<div class="col-md-8">
<!-- 														<input type="text" class="form-control" name="product[name]" placeholder="请选择产品……" value="" readonly> -->
<!-- 														<br><a href="#product-pick" class="col-md-8 product-pick" data-toggle="modal">点击此处选择产品</a> -->
														<input type="text" name="poItem[product-id]" style="display: none;">
														<div class="input-group">
																<input type="text" class="form-control" placeholder="请选择拜访对象…" name="product[name]" readonly>
																	<span class="input-group-addon">
																	<a href="#product-pick" class="product-pick" data-toggle="modal"><i class="fa fa-search"></i>
																	</a>
																	</span>
								...
								<div class="form-group">
								<label class="col-md-3 control-label">拜访方式：</label>
								<select class="col-md-8 currency" name="po[currency]">
									<option value="${currency.list_name}">现场拜访</option>
									<option value="${currency.list_name}">电话拜访</option>
									<option value="${currency.list_name}">邮件拜访</option>
								</select>
								</div>
								<div class="form-group">
								<label class="col-md-3 control-label">拜访状态</label>
								<select class="col-md-8 currency" name="po[currency]">
								...
								<div class="form-group">
									<input type="text" name="warehouse[id]" style="display :none;" value="">
													<label class="col-md-3 control-label">拜访人： <span class="required">
													* </span>
													</label>
													<div class="col-md-8">
														<div class="input-group">
																<input type="text" class="form-control" placeholder="请选择拜访人…" name="warehouse[name]" readonly>
																	<span class="input-group-addon">
																	<a href="#receive-wh-pick" class="receive-wh-pick" data-toggle="modal"><i class="fa fa-search"></i>
																	</a>
																	</span>
							 	...
							 	<div class="form-group">
															<label class="col-md-3 control-label" for="endtime">计划拜访时间：</label>
															<div class="col-md-8">
								...
								<div class="form-group">
															<label class="col-md-3 control-label" for="endtime">实际拜访时间：</label>
															<div class="col-md-8">
																<div class="input-group input-medium date date-picker"
																	data-date-format="yyyy-mm-dd"
																	data-date="">
								...
								<div class="form-group">
													<label class="col-md-3 control-label">拜访描述：
													</label>
													<div class="col-md-8">
														<textarea class="form-control" rows="2"	placeholder="输入拜访描述…" name="item_comment"></textarea>
													</div>
								</div>
								<div class="form-group">
													<label class="col-md-3 control-label">信息反馈：
													</label>
													<div class="col-md-8">
														<textarea class="form-control" rows="2"	placeholder="输入信息反馈…" name="item_comment"></textarea>
													</div>
								</div>
							</div>
						</form>
