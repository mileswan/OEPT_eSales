 ...
 * Version: 1.0
 * Date: 2016/4/18
 * Description:  Opportunities list management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
...
<!-- 								</div> -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/opty/opty_list.do">待审核商机列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
...
<!-- 									</div> -->
	                		...
	                		<tr class="odd gradeX" id="${purchase_order.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/opty/opty_details.do">
	                    		2-19282461782</a></td>
	                    		<td>
	                    			四季度园区网络改造项目计划        		
								</td>
