 ...
 * Version: 1.0
 * Date: 2016/12/28
 * Description:  Opportunities details management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE MODALS-->
			<jsp:include page="opty_modals.jsp" />
			<!-- BEGIN PAGE MODALS-->
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			商机详情 <small>查看商机详情</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/order/po_list.do">我的商机列表</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path %>/order/po_details.do?id=${order.order_id}">商机详情</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			...
			<!-- BEGIN PAGE CONTENT-->
			<jsp:include page="opty_contents.jsp" />
			<!-- END PAGE CONTENT-->
		</div>
	</div>
	<!-- END CONTENT -->
