 ...
 * Version: 1.0
 * Date: 2016/1/12
 * Description:  Stock Out requisition list management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
...
<!-- 								</div> -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/inventory/stock_out_list.do">库存管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path%>/inventory/stock_out_list.do">我的出库单列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
...
<!-- 									</div> -->
	                		...
	                		<tr class="odd gradeX" id="${requisition.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/inventory/stock_out_details.do?id=${requisition.requisition_id}">
