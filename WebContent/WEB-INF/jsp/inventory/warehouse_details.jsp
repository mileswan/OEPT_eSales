												...
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入仓库编号…" name="warehouse[number]" id="warehouse-number" value="${warehouseDetails.number}">													
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label">仓库名称：<span class="required">* </span></label>
															<input type="text" class="form-control" placeholder="请输入仓库名称…" name="warehouse[name]" id="warehouse-name" value="${warehouseDetails.name}">													
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
																<label class="control-label">仓库联系人：</label>
															<input type="text" class="form-control" placeholder="请输入联系人名称…" name="warehouse[contact_name]" id="wh_contact_name" value="${warehouseDetails.primary_contact_name}">	
														</div>
													</div>
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label">仓库联系人电话：</label>
															<input type="text" class="form-control" placeholder="请输入联系人电话…" name="warehouse[contact_phone]" id="wh_contact_phone" value="${warehouseDetails.primary_contact_cellphone}">	
														</div>
													</div>
												</div>
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" placeholder="请输入详细地址…" id="wh_address_name" name="warehouse[address_name]" value="${warehouseDetails.address_name}">
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-md-3">
														<div class="form-group">
															...
															<div class="radio-list">
																...
																<input type="radio" name="warehouse[acitve]" id="warehouse-active" value="true" <c:if test="${warehouseDetails.active==true}"> checked</c:if>> 可用</label>
																<label class="radio-inline">
																<input type="radio" name="warehouse[acitve]" id="warehouse-active" value="false" <c:if test="${warehouseDetails.active==false}"> checked</c:if>> 禁用 </label>
															</div>
														</div>
													</div>
												</div>
...
<!-- 																				<td> -->
<%-- 																				<c:choose> --%>
<%-- 																						<c:when test="${item.item_product_status == 'Published'}"> --%>
<%-- 																							<span class="label label-sm label-success">${item.item_product_status_val}</span> --%>
<%-- 																						</c:when> --%>
<%-- 																						<c:when test="${item.item_product_status == 'Deleted'}"> --%>
<%-- 																							<span class="label label-sm label-danger">${item.item_product_status_val}</span> --%>
<%-- 																						</c:when> --%>
<%-- 																						<c:otherwise> --%>
<%-- 																							<span class="label label-sm label-info">${item.item_product_status_val}</span> --%>
<%-- 																						</c:otherwise> --%>
<%-- 																					</c:choose> --%>
<!-- 																				</td> -->
