...
<!-- 								</div> -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/inventory/stock_in_approval_list.do">库存管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>待审核入库单列表
							</div>
							<div class="tools">
...
<!-- 									</div> -->
	                		...
	                		<tr class="odd gradeX" id="${requisition.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/inventory/stock_in_approval_details.do?id=${requisition.requisition_id}">
