 ...
 * Version: 1.0
 * Date: 2016/1/11
 * Description:  Stock In requisition all list management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
...
<!-- 								</div> -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/inventory/stock_in_all_list.do">库存管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
...
<!-- 									</div> -->
	                		...
	                		<tr class="odd gradeX" id="${requisition.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/inventory/stock_in_all_details.do?id=${requisition.requisition_id}">
