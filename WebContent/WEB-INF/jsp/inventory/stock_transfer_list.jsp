...
<!-- 								</div> -->
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/order/po_list.do">采购管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path%>/order/po_list.do">采购单列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
...
<!-- 									</div> -->
	                		...
	                		<tr class="odd gradeX" id="${purchase_order.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/order/po_details.do?id=${purchase_order.order_id}">
