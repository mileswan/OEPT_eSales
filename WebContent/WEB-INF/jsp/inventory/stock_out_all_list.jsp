 ...
 * Version: 1.0
 * Date: 2016/1/12
 * Description:  Stock Out requisition all list management page.
 */
-->
<html lang="en">
<!-- BEGIN HEAD -->
			...
			<div class="modal fade" id="new-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title">新建出库单</h4>
						</div>
						<div class="modal-body">
						<div class="row">
							<div class="col-md-12">
								<label class="control-label">出库单人工编号：</label>
								<input type="text" class="form-control" placeholder="请输入出库单编号…" name="req[man-number]">
<!-- 								<div class="form-group"> -->
<!-- 									<label class="control-label">集成商：<span class="required">* </span></label> -->
<!-- 									<input type="text" name="req[customer-id]" style="display: none;"> -->
<!-- 									<div class="input-group"> -->
<!-- 											<input type="text" class="form-control" placeholder="请选择集成商…" name="req[customer-name]" readonly> -->
...
<!-- 									</div> -->
<!-- 								</div> -->
								<label class="control-label">出库类型：<span class="required">* </span></label>
								<select class="form-control" name="req[type]">
									<c:forEach var="stock_out_type" items="${stock_out_type_list}">
										<option value="${stock_out_type.list_name}">${stock_out_type.list_value}</option>
									</c:forEach>
								</select>
								<div class="form-group">
									...
									<div class="input-group">
											<input type="text" class="form-control" placeholder="请选择发货仓库…" name="req[warehouse-name]" readonly>
											<span class="input-group-addon">
								...
								<div class="form-group">
															<label class="control-label" for="endtime">出库日期：</label>
																<div class="input-group input-medium date date-picker"
																	data-date-format="yyyy-mm-dd"
																	data-date="">
																	<input type="text" class="form-control" readonly
																		name="req[delivery_date]" value="">
						...
						<div class="modal-footer">
							...
							<button type="button" id="new-req-cancel" class="btn default" data-dismiss="modal">取消</button>
						</div>
					</div>
					<!-- /.modal-content -->
				</div>
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path%>/inventory/stock_out_all_list.do">库存管理</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="<%=path%>/inventory/stock_out_all_list.do">所有出库单列表</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
...
<!-- 												<a href="soo_import_view.do" class="btn blue"> -->
...
<!-- 									</div> -->
							...
							<table class="table table-striped table-bordered table-hover" id="stock_out_list">
							<thead>
							<tr>
								<th class="table-checkbox">
									<input type="checkbox" class="group-checkable" data-set="#stock_out_list .checkboxes"/>
								</th>
								<th>
									 系统编号
								</th>
	                		...
	                		<tr class="odd gradeX" id="${requisition.order_id}">
	                    		...
	                    		<td><a href="<%=path%>/inventory/stock_out_all_details.do?id=${requisition.requisition_id}">
	                    		${requisition.requisition_number}</a></td>
	                    		<td>
	                    			${requisition.requisition_manual_number}        		
								</td>
	                    		<td>
	                    			${requisition.delivery_wh_name} 	
	                    		</td>
	                    		<td>
...
<script src="../scripts/inventory/stock-out-list-events.js" type="text/javascript"></script>
<script>
jQuery(document).ready(function() {    
	   Metronic.init(); // init metronic core components
	   navigationBar.activeInventoryMenu();
	   $('ul.sub-menu').find('li').removeClass('active');
	   $('li.inventory-menu').find('ul.sub-menu').children('li:eq(2)').addClass('active');
