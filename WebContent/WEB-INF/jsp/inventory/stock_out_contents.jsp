																...
																<div class="col-md-7 value">
																	<select class="form-control" name="req[subtype]" <c:if test="${readOnlyFlag == true}">readonly</c:if>>
																		<c:forEach var="stock_out_type" items="${stock_out_type_list}">
																			<option value="${stock_out_type.list_name}" <c:if test="${requisitionDetails.requisition_subtype_cd == stock_out_type.list_name}">selected</c:if> >${stock_out_type.list_value}</option>
																		</c:forEach>
																	</select>
																</div>
														</div>
															...
															<div class="col-md-7 value">
																<div class="input-group input-medium date date-picker"
																	...
																	<input type="text" class="form-control" readonly
																		name="req[delivery_date]" value="${requisitionDetails.delivery_date}">
...
<!-- 														<div class="row static-info"> -->
<!-- 															<div class="col-md-5 name"> -->
<%-- 																出库单总金额（${requisitionDetails.currency_val}）: --%>
<!-- 															</div> -->
...
<%-- 															 基础金额合计（${requisitionDetails.currency_val}）: --%>
<!-- 														</div> -->
...
<!-- 													</div> -->
	                		...
	                		<tr class="odd gradeX" id="${related_order.order_id}">
	                    		<td><a href="<%=path%>/order/so_details.do?id=${related_order.order_id}">
