		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/system/approval_rule_add.do">修改审批规则</a>
					</li>
				</ul>
			</div>
																...
																<table class="item-t">
																	<tr class="item-t-tr">
																		...
																		<td class="item-t-td-r" colspan="2">
																			<div class="radio-list" id="methodDiv">
																				<label class="radio-inline" name="Anyone Pass">
																				<input type="radio" name="optionsRadios3" id="Anyone Pass" value="一个通过即可" checked="checked"> 一个通过即可</label>
																				<label class="radio-inline" name="All Must Pass">
																				<input type="radio" name="optionsRadios3" id="All Must Pass" value="全部通过才可以"> 全部通过才可以 </label>
																				<label class="radio-inline" name="Anyone Pass and Anyone Reject">
																				<input type="radio" name="optionsRadios3" id="Anyone Pass and Anyone Reject" value="一个通过即可，一个拒绝就回退"> 一个通过即可，一个拒绝就回退 </label>
																			</div>
																		</td>
																	</tr>
																	<tr><td></td><td></td></tr>
										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="输入名称.." value="" name="aName" id="${ruleId }">
														<input type="text" class="form-control" value="${ruleId }" name="ruleId" style="display: none;">
													</div>
												</div>
												<div class="form-group">
...
<!-- 																</li> -->
																...
																<li>
																	<a class="approvalObject" id="Product">产品</a>
																</li>
																<li>
																	<a class="approvalObject" id="Account">客户</a>
																</li>
<!-- 																<li> -->
												...
												<div class="form-group" id="approvalType">
													...
													<div class="col-md-8">
														<div class="input-group">
															...
															<div class="radio-list" id="type2" style="display: none;">
																<label class="radio-inline">
																<input type="radio" name="optionsRadiosType2" id="Submit2" value="提交" checked> 提交 </label>
															</div>
														</div>
													</div>
												</div>
												<div class="form-group" id="approvalRollback">
													<label class="col-md-3 control-label">回退方式：</label>
													<div class="col-md-8">
														<div class="input-icon">
															<div class="radio-list" >
																<label class="radio-inline" name="Revert">
																<input type="radio" name="optionsRadios2" id="Revert" value="退回到上一步" checked="checked"> 退回到上一步 </label>
																<label class="radio-inline" name="Restart">
																<input type="radio" name="optionsRadios2" id="Restart" value="重新从第一步开始 "> 重新从第一步开始 </label>
																<label class="radio-inline" name="Cancel">
...
<!-- 														<button class="btn green btn-block" id="submitApprDetail">保存流程</button> -->
														<a href="#" class="btn green btn-block" id="submitApprDetail">保存流程</a>
													</div>
												</div>
											</div>
										</form>
...
<!-- end -->
<script src="../scripts/system/approval-events-detail.js" type="text/javascript"></script>
