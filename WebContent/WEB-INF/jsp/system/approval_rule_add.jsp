		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=path %>/system/approval_rule_add.do">添加审批规则</a>
					</li>
				</ul>
			</div>
										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="输入名称.." value="" name="aName" id="">
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-8">
														<div class="input-group">
															<div class="radio-list" id="type1">
																...
																<input type="radio" name="optionsRadios" id="Submit" value="提交单据" checked> 提交单据 </label>
																<label class="radio-inline">
															...
															<div class="radio-list" id="type2" style="display: none;">
																<label class="radio-inline">
																<input type="radio" name="optionsRadiosType2" id="New" value="新建" checked> 新建 </label>
															</div>
														</div>
													</div>
												</div>
...
<!-- 														<button class="btn green btn-block" id="submitAppr">保存流程</button> -->
														<a href="#" class="btn green btn-block" id="submitAppr">保存流程</a>
													</div>
												</div>
											</div>
										</form>
