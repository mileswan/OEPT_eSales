...
//    				var address_name = table.rows[i].cells[1].innerText;
					...
					$('input[name="account[addressId]"]').attr('id',id);
    				$('input[name="account[address]"]').val(a_country+a_province+a_city+a_county);
    			}
    		}
    	});
    }
  ...
  //查询审核流程
    ...
    var saveEdit = function(){
    	...
    	var from_data = {
    			...
    			aDesc :  $("textarea[name='account[description]']").val(), //公司描述
    			aComm :  $("textarea[name='account[spec]']").val(),
