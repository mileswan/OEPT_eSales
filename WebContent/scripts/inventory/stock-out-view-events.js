 ...
 * Version: 1.0
 * Date: 2016/1/14
 * Description: Stock out requisition view events handlers.
 */
var StockOutViewEvents = function(){
	// initialize events function for all elements.
    var initStockOutViewEvents = function() {
    		...
    		for(var i=1;i<table.rows.length;i++){		
    			if(table.rows[i].cells[0].getElementsByTagName('input')[0].checked){
    				...
    				var supplierInfo = '<div class="row static-info"><div class="col-md-5 name">\
    					...
    					<div class="row static-info"><div class="col-md-5 name">\
    					仓库名称:</div><div class="col-md-7 value"> <a href="warehouse_details.do?id='+id+'">'+table.rows[i].cells[2].innerText+'</a></div></div> \
    					<div class="row static-info"><div class="col-md-5 name">\
    	...
    	$('a.req-base-update').click(function() {
    		...
    		var delivery_date = $('input[name="req[delivery_date]"]').val();
    ...
    var updateReqStatus = function(status_code) {
		...
		$.ajax({
            ...
            data: {status_code:status_code,
            	type_code:"Stock Out Requisition",
            	reqId:reqId},
            dataType: "text",
            success: function (result) {	
            	var responseJson = eval ("(" + result + ")");
    ...
    var updateOrderInfo = function(dataJson) {
		...
		$.ajax({
            ...
            data: {customer_id:dataJson.customer_id,
            	...
            	delivery_date:dataJson.delivery_date,
...
//            	updateReqAmounts(base_total,due_total);
    ...
    //handle stock out requisition approval history list
