 ...
 * Version: 1.0
 * Date: 2016/1/6
 * Description: Purchase Return Orders view events handlers.
 */
var PORViewEvents = function(){
    ...
    var initPOViewEvents = function() {
    	...
    	$("button.back").click(function() {
	    	window.location.href='po_return_list.do';
	    });
    	...
    	$('button.owner-pick').click(function() {
    		...
    		updateOrderInfo(null,null,id,null);
    	});
    	//End owner pick
    ...
    var updateOrderStatus = function(status_code) {
		...
		$.ajax({
            ...
            data: {status_code:status_code,
            	type_code:"Purchase Return Order",
            	orderId:orderId},
            dataType: "text",
            success: function (result) {	
            	var responseJson = eval ("(" + result + ")");
